...
# 18 "Lab04.s" 2
 ...
 BTFSC ((INTCON) and 07Fh), 0 ; Vericamos si hay interrupción de cambio en el puerto B
 ...
 BTFSS ((STATUS) and 07Fh), 2 ; Verificación de la bandera del ((STATUS) and 07Fh), 2
 return
 ...
 BSF ((INTCON) and 07Fh), 3 ; Habilitamos las interrupciones por cambio de estado del PORTB
 BCF ((INTCON) and 07Fh), 0 ; Limpieza de la bandera de la interrupción de cambio
 ...
 BSF WPUB, B_INC ; Habilita el registro de pull-up en ((PORTB) and 07Fh), 0
 BSF WPUB, B_DEC ; Habilita el registro de pull-up en ((PORTB) and 07Fh), 1
